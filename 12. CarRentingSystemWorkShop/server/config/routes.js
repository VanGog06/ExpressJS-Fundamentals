...
module.exports = (app) => {
  ...
  app.get('/cars/edit/:id', auth.isInRole('Admin'), auth.isAuthenticated, controllers.cars.editGet);
  app.post('/cars/edit/:id', auth.isInRole('Admin'), auth.isAuthenticated, controllers.cars.editPost);
